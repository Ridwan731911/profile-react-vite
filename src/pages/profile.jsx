    ...
    <div className="font-sans bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 text-gray-900 min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white py-16 sm:py-20 lg:py-24 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-32 right-4 sm:top-40 sm:right-20 opacity-15 animate-bounce" style={{ animationDelay: "0.5s" }}>
            <Database size={35} className="sm:w-12 sm:h-12 text-white" />
          </div>
          <div className="absolute bottom-16 left-4 sm:bottom-20 sm:left-20 opacity-10 animate-pulse" style={{ animationDelay: "1s" }}>
            <Server size={30} className="sm:w-11 sm:h-11 text-white" />
          </div>
          <div className="absolute top-48 left-1/2 transform -translate-x-1/2 opacity-10 animate-bounce" style={{ animationDelay: "1.5s" }}>
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          <div className="flex justify-center items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            <Code2 size={36} className="sm:w-12 sm:h-12 text-indigo-200 animate-bounce" />
          ...
          <p className="text-sm sm:text-base md:text-lg text-indigo-50 max-w-4xl mx-auto mb-6 sm:mb-8 leading-relaxed px-4">
            Saya seorang developer berpengalaman yang siap membantu Anda dengan tugas programming, 
            web development, database, dan berbagai proyek teknologi. Mari wujudkan ide digital Anda bersama!
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            ...
            >
              <MessageCircle size={18} className="sm:w-5 sm:h-5 group-hover:animate-bounce" />
              <span className="text-sm sm:text-base">Konsultasi via WhatsApp</span>
            </a>
            <div className="flex items-center gap-2 text-indigo-100">
              <CheckCircle size={14} className="sm:w-4 sm:h-4" />
              <span className="text-xs sm:text-sm">Respon cepat & profesional</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex justify-center mb-6">
            <div className="p-3 sm:p-4 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl shadow-lg">
              <GraduationCap size={36} className="sm:w-12 sm:h-12 text-indigo-600" />
            </div>
          </div>
          ...
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-8 sm:mb-12 max-w-4xl mx-auto px-4">
            Saya adalah seorang developer yang berpengalaman dalam berbagai teknologi modern. 
            Dengan passion untuk coding dan berbagi pengetahuan, saya siap membantu Anda 
            menyelesaikan proyek-proyek teknologi, mulai dari website sederhana hingga 
            aplikasi kompleks. Mari berkolaborasi untuk mewujudkan visi digital Anda!
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} className="bg-gradient-to-br from-gray-50 to-white p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex justify-center mb-3 sm:mb-4">
                  <div className="p-2 sm:p-3 bg-white rounded-xl shadow-md">
                    {item.icon}
                  </div>
                </div>
                <h4 className="font-bold text-gray-800 mb-2 text-sm sm:text-base">{item.title}</h4>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Solusi teknologi lengkap untuk berbagai kebutuhan development dan programming Anda
            </p>
          </div>
            ...
            {[
              {
                ...
                skills: ["React.js", "Node.js", "Vue.js", "Express.js", "TypeScript"]
              },
              {
              ...
              },
              {
                ...
                skills: ["React", "Next.js", "API Development", "Responsive Design"]
              },
              {
                ...
                skills: ["REST API", "GraphQL", "Authentication", "Third-party Integration"]
              },
              {
                ...
                skills: ["IT Consulting", "System Optimization", "Code Review", "Best Practices"]
              },
              {
                ...
                skills: ["Technical Report", "System Documentation", "Project Proposal", "Presentation"]
              }
            ].map((item, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">{item.desc}</p>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
              Proses development yang terstruktur dan transparan untuk hasil yang optimal
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <div key={i} className="text-center group">
                ...
                <h4 className="font-bold text-gray-800 mb-2 sm:mb-3 text-sm sm:text-base">{item.title}</h4>
                <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { 
                category: "Frontend", 
                items: ["JavaScript (ES6+)", "React.js", "Vue.js", "Next.js", "TypeScript", "Tailwind CSS"], 
                color: "from-blue-400 to-indigo-600" 
              },
              { 
                category: "Backend", 
                items: ["Node.js", "Express.js", "Python", "Java", "PHP", "REST API"], 
                color: "from-emerald-400 to-teal-600" 
              },
              { 
                category: "Database", 
                items: ["MySQL", "PostgreSQL", "MongoDB", "Redis", "Firebase", "Prisma"], 
              ...
              <div key={i} className="bg-white p-4 sm:p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className={`w-full h-1 bg-gradient-to-r ${skillGroup.color} rounded-full mb-4`}></div>
                <h4 className="font-bold text-gray-800 mb-4 sm:mb-6 text-sm sm:text-base">{skillGroup.category}</h4>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-6 sm:p-8 lg:p-10 rounded-3xl shadow-xl">
            ...
            <div className="mb-6 sm:mb-8">
              <p className="text-gray-700 mb-4 sm:mb-6 text-sm sm:text-base">
                Berlokasi di Sleman, Yogyakarta - Siap melayani klien dari seluruh Indonesia
              </p>

              <div className="w-full h-48 sm:h-64 lg:h-80 rounded-2xl overflow-hidden shadow-lg mb-4 sm:mb-6">
                <iframe
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl hover:from-indigo-600 hover:to-purple-700 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:scale-105 text-sm sm:text-base"
              >
      ...
      <footer className="bg-gray-900 text-white py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="border-t border-gray-800 pt-4 sm:pt-6 text-center">
            <p className="text-gray-400 text-xs sm:text-sm">&copy; 2025 Awans. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
